...
uint64_t get_memory_map_entries(uint64_t map);
uint64_t get_memory_map_base(uint64_t map);
uint64_t get_memory_map_length(uint64_t map);
uint64_t get_memory_map_type(uint64_t map);
